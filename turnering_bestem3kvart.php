...
//if($turnering["kvartfinaler_start"] == 0){
    ...
    $opdater = mysqli_query($GLOBALS['link'],"UPDATE hbf_turnering SET kvartfinaler = '$kvartfinalertotal' WHERE turnering_id = '$turnerings_id'");
...
<div class='g12'>
 ...
 <div></div>
    <?
    $nummerOld = $nummer ="";
    $puljer = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_puljer WHERE turnerings_id = '".$turnering["turnering_id"]."' order by pulje_nr, point DESC, (maal_scoret-maal_gaaetind) DESC,maal_scoret DESC,kampe DESC,pulje_id DESC") or die(mysqli_error($GLOBALS['link']));
