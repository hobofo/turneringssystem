...
$query = mysqli_query($link,"DELETE FROM hbf_spillere WHERE spiller_id = '$spillerid1' OR spiller_id = '$spillerid2'");

$bruger1 = hentbruger($spiller1);
$bruger2 = hentbruger($spiller2);
$rang = $bruger1["rangliste"] + $bruger2["rangliste"];
$query = mysqli_query($link,"INSERT INTO hbf_spillere (turnering_id,spiller,medspiller,primaer,rang) values ('$turneringsid','$spiller1','$spiller2','1',$rang)");
$query = mysqli_query($link,"INSERT INTO hbf_spillere (turnering_id,spiller,medspiller,primaer,rang) values ('$turneringsid','$spiller2','$spiller1','0',$rang)");
