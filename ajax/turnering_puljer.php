...
?>
    <?
    $nummerOld = $nummer ="";
    $puljer = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_puljer WHERE turnerings_id = '".$turnering["turnering_id"]."' order by pulje_nr, point DESC, (maal_scoret-maal_gaaetind) DESC,maal_scoret DESC,kampe DESC,initial_placering,spiller_id") or die(mysqli_error($GLOBALS['link']));
