...
if($antalhold >= 16){
    ...
    $henterhold = mysqli_query($link,"SELECT * FROM hbf_puljer WHERE turnerings_id = '$turnerings_id' and rangering_total  = 16 ORDER BY rangering_total") or die(mysql_error());
