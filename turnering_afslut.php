...
// Finaler
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 'f'") or die(mysqli_error($GLOBALS['link']));
...
// Semifinaler
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 's'") or die(mysqli_error($GLOBALS['link']));
...
// Kvartfinaler
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 'k'") or die(mysqli_error($GLOBALS['link']));
while($row = mysqli_fetch_array($hent)){
    if($row["vinder"] == $row["hold1"]){
...
// Finaler
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 'jf'") or die(mysqli_error($GLOBALS['link']));
$row = mysqli_fetch_array($hent);
...
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 'js'") or die(mysqli_error($GLOBALS['link']));
while($row = mysqli_fetch_array($hent)){
    if($row["vinder"] == $row["hold1"]){
        $tabersemifinale[] = $row["hold2"];
    } else {
...
// Kvartfinaler
$taberkvart = array();
$hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_kampe WHERE turnerings_id = '$turnerings_id' AND type = 'jk'") or die(mysqli_error($GLOBALS['link']));
while($row = mysqli_fetch_array($hent)){
    if($row["vinder"] == $row["hold1"]){
        $taberkvart[] = $row["hold2"];
    } else {
...
if(isset($_GET["afslut"]) && $turnering["ended"] != 1){
    mysqli_query($GLOBALS['link'],"UPDATE hbf_turnering SET ended=1 WHERE turnering_id = '$turnerings_id'") or die(mysqli_error($GLOBALS['link']));
    // Kan kun opdateres en gang
    $hent = mysqli_query($GLOBALS['link'],"SELECT * FROM hbf_rangliste WHERE turnerings_id = '$turnerings_id'");
