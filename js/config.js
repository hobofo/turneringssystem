...
if($.fn.wl_Form) $.fn.wl_Form.defaults = {
	...
	text: {
		...
		valid: 'Dette felt er ikke udfyldt korrekt',
		password: 'Dette kodeord er for kort',
		passwordmatch: 'Dette kodeord passer ikke med det andet',
		fileinqueue: 'Der er en fil i kø',
		incomplete: 'Udfyld venligst felterne korrekt',
		send: 'Send formular...',
		sendagain: 'Send igen?',
		success: 'Formular sendt!',
		error: 'Fejl ved afsending!',
		parseerror: 'Kan ikke udfører query string:\n %e'
	},
	tooltip: {
		gravity: 'nw'
	},
...
if($.fn.wl_Password) $.fn.wl_Password.defaults = {
	confirm: true,
	showStrength: true,
	words: ['for kort', 'dårligt', 'ok', 'godt', 'meget godt', 'fantastisk'],
	minLength: 3,
	text: {
		confirm: 'gentag kodeord',
		nomatch: 'kodeord er ikke ens'
	}
};
