...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				"sProcessing": "Henter...",
				"sLengthMenu": "Vis _MENU_ rækker på hver side",
				"sZeroRecords": "Intet resultateter for de valgte søgeord",
				"sEmptyTable": "Ingen data er tilgængelig",
				"sInfo": "Viser _START_ til _END_ af _TOTAL_ rækker",
				"sInfoEmpty": "Viser 0 til 0 af 0 rækker",
				"sInfoFiltered": "(filtreret fra _MAX_ antal rækker)",
				"sInfoPostFix": "",
				"sSearch": "Søg:",
				"sUrl": "",
				"oPaginate": {
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select size="1" '+sName+'><optgroup label="Antal rækker">';
			var i, iLen;
